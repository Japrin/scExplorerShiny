...
### })
    ...
    if(InputValue$ngene.show>0){
      if(input$Embedding_GenePar=="Mean"){
          ...
          p <- sscVis::ssc.plot.tsne(sce.mean,
                                      ...
                                      my.ggPoint=c("geom_point"=ggplot2::geom_point,
                                                   "geom_point_rast"=ggrastr::geom_point_rast,
                                                   "geom_scattermore"=scattermore::geom_scattermore)[[input$Embedding_gene_scatter_function]],
  ...
  output$Embedding_metaplot <- renderPlot({
    p <- sscVis::ssc.plot.tsne(InputValue$sce.plot,
                                ...
                                my.ggPoint=c("geom_point"=ggplot2::geom_point,
                                             "geom_point_rast"=ggrastr::geom_point_rast,
                                             "geom_scattermore"=scattermore::geom_scattermore)[[input$Embedding_metaInfo_scatter_function]],
